...
Public Class lenel34
    ...
    Public Sub conectar()
        Conn.ConnectionString = "Data Source=172.30.60.21;Initial Catalog=Lenel_Eventos;User ID=apilac;PASSWORD=apilac;timeout=600000;"
        constr = "Data Source=172.30.60.21;Initial Catalog=Lenel_Eventos;User ID=apilac;PASSWORD=apilac"
        Try
            Conn.Open()
